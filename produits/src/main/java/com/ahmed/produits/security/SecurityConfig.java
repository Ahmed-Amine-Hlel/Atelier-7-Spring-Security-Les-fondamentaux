...
auth.inMemoryAuthentication().withUser("admin").password(passwordEncoder.encode("hlel")).roles("ADMIN");
auth.inMemoryAuthentication().withUser("ahmed").password(passwordEncoder.encode("hlel")).roles("AGENT","USER");
auth.inMemoryAuthentication().withUser("amine").password(passwordEncoder.encode("hlel")).roles("USER");
}
